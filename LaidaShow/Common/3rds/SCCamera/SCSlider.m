...
#define DARK_WHITE_COLOR        [UIColor colorWithRed:255/255.0f green:250/255.0f blue:250/255.0f alpha:1.f]    //深绿色
...
//        _value = 0;
        ...
        self.bgLineColor = [UIColor yellowColor];// LIGHT_GREEN_COLOR;
        self.slidedLineColor = [UIColor yellowColor];//DARK_GREEN_COLOR;
