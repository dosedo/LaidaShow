...
- (UIImage *)getChangeImage{
    ...
    CGSize imgSize = CGSizeMake(self.textField.frame.size.width , self.textField.frame.size.height);
    ...
    if (self.textField.transform.a<0) {
    ...
    dict[NSFontAttributeName] = self.textField.font;
    dict[NSForegroundColorAttributeName] = self.textField.textColor;
    
    [self.textField.text drawInRect:CGRectMake(0, 0, imgSize.width, imgSize.height) withAttributes:dict];
